...
export namespace user {
    export class CreateUserRequest extends pb_1.Message {
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.last_name.length) writer.writeString(2, this.last_name);
            if (this.password.length) writer.writeString(3, this.password);
            if (this.refresh_token.length) writer.writeString(4, this.refresh_token);
            if (this.is_active != false) writer.writeBool(5, this.is_active);
            if (this.email.length) writer.writeString(6, this.email);
            if (this.address.length) writer.writeString(7, this.address);
            if (this.location_s3.length) writer.writeString(8, this.location_s3);
            if (this.verification_code.length) writer.writeString(9, this.verification_code);
            if (this.expire_verification_code.length) writer.writeString(10, this.expire_verification_code);
            if (this.role_id.length) writer.writeString(11, this.role_id);
            if (this.permission_ids.length) writer.writeRepeatedString(12, this.permission_ids);
    ...
    export class RegisterUserRequest extends pb_1.Message {
        ...
        static fromObject(data: { email?: string; password?: string }): RegisterUserRequest {
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): RegisterUserRequest {
            const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes),
                message = new RegisterUserRequest();
            while (reader.nextField()) {
                if (reader.isEndGroup()) break;
                switch (reader.getFieldNumber()) {
                    case 1:
    ...
    export class RegisterMediaUserRequest extends pb_1.Message {
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            const writer = w || new pb_1.BinaryWriter();
            if (this.email.length) writer.writeString(1, this.email);
            if (this.picture.length) writer.writeString(2, this.picture);
            if (this.givenName.length) writer.writeString(3, this.givenName);
            if (this.familyName.length) writer.writeString(4, this.familyName);
            if (this.sub.length) writer.writeString(5, this.sub);
            if (!w) return writer.getResultBuffer();
        }
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): RegisterMediaUserRequest {
            const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes),
                message = new RegisterMediaUserRequest();
            while (reader.nextField()) {
                if (reader.isEndGroup()) break;
                switch (reader.getFieldNumber()) {
                    case 1:
    ...
    export class CreateUserResponse extends pb_1.Message {
        ...
        static fromObject(data: { message?: string; user?: ReturnType<typeof User.prototype.toObject> }): CreateUserResponse {
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): CreateUserResponse {
            const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes),
                message = new CreateUserResponse();
            while (reader.nextField()) {
                if (reader.isEndGroup()) break;
                switch (reader.getFieldNumber()) {
                    case 1:
    ...
    export class RegisterMediaUserResponse extends pb_1.Message {
        ...
        static fromObject(data: { message?: string; user?: ReturnType<typeof User.prototype.toObject>; token?: string }): RegisterMediaUserResponse {
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): RegisterMediaUserResponse {
            const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes),
                message = new RegisterMediaUserResponse();
            while (reader.nextField()) {
                if (reader.isEndGroup()) break;
                switch (reader.getFieldNumber()) {
                    case 1:
    ...
    export class GetUserResponse extends pb_1.Message {
        ...
        static fromObject(data: { users?: ReturnType<typeof User.prototype.toObject>[] }): GetUserResponse {
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            const writer = w || new pb_1.BinaryWriter();
            if (this.users.length) writer.writeRepeatedMessage(1, this.users, (item: User) => item.serialize(writer));
            if (!w) return writer.getResultBuffer();
        }
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): GetUserResponse {
            const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes),
                message = new GetUserResponse();
            while (reader.nextField()) {
                if (reader.isEndGroup()) break;
                switch (reader.getFieldNumber()) {
                    case 1:
    ...
    export class GetUserByIdResponse extends pb_1.Message {
        ...
        static fromObject(data: { user?: ReturnType<typeof User.prototype.toObject> }): GetUserByIdResponse {
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): GetUserByIdResponse {
            const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes),
                message = new GetUserByIdResponse();
            while (reader.nextField()) {
                if (reader.isEndGroup()) break;
                switch (reader.getFieldNumber()) {
                    case 1:
    ...
    export class UpdateUserRequest extends pb_1.Message {
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.last_name.length) writer.writeString(3, this.last_name);
            if (this.password.length) writer.writeString(4, this.password);
            if (this.refresh_token.length) writer.writeString(5, this.refresh_token);
            if (this.is_active != false) writer.writeBool(6, this.is_active);
            if (this.email.length) writer.writeString(7, this.email);
            if (this.address.length) writer.writeString(8, this.address);
            if (this.location_s3.length) writer.writeString(9, this.location_s3);
            if (this.verification_code.length) writer.writeString(10, this.verification_code);
            if (this.expire_verification_code.length) writer.writeString(11, this.expire_verification_code);
            if (this.role_id.length) writer.writeString(12, this.role_id);
            if (this.permission_ids.length) writer.writeRepeatedString(13, this.permission_ids);
            if (!w) return writer.getResultBuffer();
        }
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): UpdateUserRequest {
            const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes),
                message = new UpdateUserRequest();
            while (reader.nextField()) {
                if (reader.isEndGroup()) break;
                switch (reader.getFieldNumber()) {
                    case 1:
    ...
    export class UpdateUserResponse extends pb_1.Message {
        ...
        static fromObject(data: { message?: string; user?: ReturnType<typeof User.prototype.toObject> }): UpdateUserResponse {
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): UpdateUserResponse {
            const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes),
                message = new UpdateUserResponse();
            while (reader.nextField()) {
                if (reader.isEndGroup()) break;
                switch (reader.getFieldNumber()) {
                    case 1:
    ...
    export class DeleteUserRequest extends pb_1.Message {
        ...
        static fromObject(data: { id?: number }): DeleteUserRequest {
    ...
    export class DeleteUserResponse extends pb_1.Message {
        ...
        static fromObject(data: { message?: string }): DeleteUserResponse {
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): DeleteUserResponse {
            const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes),
                message = new DeleteUserResponse();
            while (reader.nextField()) {
                if (reader.isEndGroup()) break;
                switch (reader.getFieldNumber()) {
                    case 1:
    ...
    export class User extends pb_1.Message {
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.verification_code.length) writer.writeString(10, this.verification_code);
            if (this.expire_verification_code.length) writer.writeString(11, this.expire_verification_code);
            if (this.has_role) writer.writeMessage(12, this.role, () => this.role.serialize(writer));
            if (this.permissions.length) writer.writeRepeatedMessage(13, this.permissions, (item: Permission) => item.serialize(writer));
            if (this.scoreBlitz != 0) writer.writeInt32(14, this.scoreBlitz);
            if (this.scoreRapid != 0) writer.writeInt32(15, this.scoreRapid);
            if (this.scoreBullet != 0) writer.writeInt32(16, this.scoreBullet);
            if (this.lastActivity.length) writer.writeString(17, this.lastActivity);
            if (!w) return writer.getResultBuffer();
        }
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    ...
                    case 12:
                        ...
                        break;
                    case 13:
                        reader.readMessage(message.permissions, () =>
                            pb_1.Message.addToRepeatedWrapperField(message, 13, Permission.deserialize(reader), Permission),
                        );
                        break;
                    case 14:
    ...
    export class Role extends pb_1.Message {
        ...
        static fromObject(data: { id?: string; name?: string }): Role {
    ...
    export class Permission extends pb_1.Message {
        ...
        static fromObject(data: { id?: string; name?: string }): Permission {
    ...
    export abstract class UnimplementedUserServiceService {
        ...
        abstract CreateUser(
            call: grpc_1.ServerUnaryCall<CreateUserRequest, CreateUserResponse>,
            callback: grpc_1.sendUnaryData<CreateUserResponse>,
        ): void;
        ...
        abstract GetUserById(
            call: grpc_1.ServerUnaryCall<GetUserByIdRequest, GetUserByIdResponse>,
            callback: grpc_1.sendUnaryData<GetUserByIdResponse>,
        ): void;
        abstract UpdateUser(
            call: grpc_1.ServerUnaryCall<UpdateUserRequest, UpdateUserResponse>,
            callback: grpc_1.sendUnaryData<UpdateUserResponse>,
        ): void;
        abstract DeleteUser(
            call: grpc_1.ServerUnaryCall<DeleteUserRequest, DeleteUserResponse>,
            callback: grpc_1.sendUnaryData<DeleteUserResponse>,
        ): void;
        abstract RegisterUser(
            call: grpc_1.ServerUnaryCall<RegisterUserRequest, CreateUserResponse>,
            callback: grpc_1.sendUnaryData<CreateUserResponse>,
        ): void;
        abstract RegisterMediaUser(
            call: grpc_1.ServerUnaryCall<RegisterMediaUserRequest, RegisterMediaUserResponse>,
            callback: grpc_1.sendUnaryData<RegisterMediaUserResponse>,
        ): void;
    }
    export class UserServiceClient extends grpc_1.makeGenericClientConstructor(UnimplementedUserServiceService.definition, 'UserService', {}) {
        ...
        CreateUser: GrpcUnaryServiceInterface<CreateUserRequest, CreateUserResponse> = (
            ...
            metadata: grpc_1.Metadata | grpc_1.CallOptions | grpc_1.requestCallback<CreateUserResponse>,
            options?: grpc_1.CallOptions | grpc_1.requestCallback<CreateUserResponse>,
            callback?: grpc_1.requestCallback<CreateUserResponse>,
        ): grpc_1.ClientUnaryCall => {
            return super.CreateUser(message, metadata, options, callback);
        };
        GetUsers: GrpcUnaryServiceInterface<GetUserRequest, GetUserResponse> = (
            message: GetUserRequest,
            metadata: grpc_1.Metadata | grpc_1.CallOptions | grpc_1.requestCallback<GetUserResponse>,
            options?: grpc_1.CallOptions | grpc_1.requestCallback<GetUserResponse>,
            callback?: grpc_1.requestCallback<GetUserResponse>,
        ): grpc_1.ClientUnaryCall => {
            return super.GetUsers(message, metadata, options, callback);
        };
        GetUserById: GrpcUnaryServiceInterface<GetUserByIdRequest, GetUserByIdResponse> = (
            message: GetUserByIdRequest,
            metadata: grpc_1.Metadata | grpc_1.CallOptions | grpc_1.requestCallback<GetUserByIdResponse>,
            options?: grpc_1.CallOptions | grpc_1.requestCallback<GetUserByIdResponse>,
            callback?: grpc_1.requestCallback<GetUserByIdResponse>,
        ): grpc_1.ClientUnaryCall => {
            return super.GetUserById(message, metadata, options, callback);
        };
        UpdateUser: GrpcUnaryServiceInterface<UpdateUserRequest, UpdateUserResponse> = (
            message: UpdateUserRequest,
            metadata: grpc_1.Metadata | grpc_1.CallOptions | grpc_1.requestCallback<UpdateUserResponse>,
            options?: grpc_1.CallOptions | grpc_1.requestCallback<UpdateUserResponse>,
            callback?: grpc_1.requestCallback<UpdateUserResponse>,
        ): grpc_1.ClientUnaryCall => {
            return super.UpdateUser(message, metadata, options, callback);
        };
        DeleteUser: GrpcUnaryServiceInterface<DeleteUserRequest, DeleteUserResponse> = (
            message: DeleteUserRequest,
            metadata: grpc_1.Metadata | grpc_1.CallOptions | grpc_1.requestCallback<DeleteUserResponse>,
            options?: grpc_1.CallOptions | grpc_1.requestCallback<DeleteUserResponse>,
            callback?: grpc_1.requestCallback<DeleteUserResponse>,
        ): grpc_1.ClientUnaryCall => {
            return super.DeleteUser(message, metadata, options, callback);
        };
        RegisterUser: GrpcUnaryServiceInterface<RegisterUserRequest, CreateUserResponse> = (
        ...
        RegisterMediaUser: GrpcUnaryServiceInterface<RegisterMediaUserRequest, RegisterMediaUserResponse> = (
            message: RegisterMediaUserRequest,
            metadata: grpc_1.Metadata | grpc_1.CallOptions | grpc_1.requestCallback<RegisterMediaUserResponse>,
            options?: grpc_1.CallOptions | grpc_1.requestCallback<RegisterMediaUserResponse>,
            callback?: grpc_1.requestCallback<RegisterMediaUserResponse>,
        ): grpc_1.ClientUnaryCall => {
