...
export namespace role {
    export class CreateRoleRequest extends pb_1.Message {
        ...
        static fromObject(data: { name?: string }): CreateRoleRequest {
    ...
    export class CreateRoleResponse extends pb_1.Message {
        ...
        static fromObject(data: { message?: string; role?: ReturnType<typeof Role.prototype.toObject> }): CreateRoleResponse {
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.has_role) writer.writeMessage(2, this.role, () => this.role.serialize(writer));
            if (!w) return writer.getResultBuffer();
        }
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): CreateRoleResponse {
            const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes),
                message = new CreateRoleResponse();
            while (reader.nextField()) {
                if (reader.isEndGroup()) break;
                switch (reader.getFieldNumber()) {
                    case 1:
    ...
    export class GetRoleRequest extends pb_1.Message {
        ...
        static fromObject(data: { id?: number }): GetRoleRequest {
    ...
    export class GetRoleResponse extends pb_1.Message {
        ...
        static fromObject(data: { role?: ReturnType<typeof Role.prototype.toObject> }): GetRoleResponse {
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            const writer = w || new pb_1.BinaryWriter();
            if (this.has_role) writer.writeMessage(1, this.role, () => this.role.serialize(writer));
            if (!w) return writer.getResultBuffer();
        }
    ...
    export class UpdateRoleRequest extends pb_1.Message {
        ...
        static fromObject(data: { id?: number; name?: string }): UpdateRoleRequest {
    ...
    export class UpdateRoleResponse extends pb_1.Message {
        ...
        static fromObject(data: { message?: string; role?: ReturnType<typeof Role.prototype.toObject> }): UpdateRoleResponse {
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): UpdateRoleResponse {
            const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes),
                message = new UpdateRoleResponse();
            while (reader.nextField()) {
                if (reader.isEndGroup()) break;
                switch (reader.getFieldNumber()) {
                    case 1:
    ...
    export class DeleteRoleRequest extends pb_1.Message {
        ...
        static fromObject(data: { id?: number }): DeleteRoleRequest {
    ...
    export class DeleteRoleResponse extends pb_1.Message {
        ...
        static fromObject(data: { message?: string }): DeleteRoleResponse {
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): DeleteRoleResponse {
            const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes),
                message = new DeleteRoleResponse();
            while (reader.nextField()) {
                if (reader.isEndGroup()) break;
                switch (reader.getFieldNumber()) {
                    case 1:
    ...
    export class Role extends pb_1.Message {
        ...
        static fromObject(data: { id?: number; name?: string }): Role {
    ...
    export abstract class UnimplementedRoleServiceService {
        ...
        abstract CreateRole(
            call: grpc_1.ServerUnaryCall<CreateRoleRequest, CreateRoleResponse>,
            callback: grpc_1.sendUnaryData<CreateRoleResponse>,
        ): void;
        ...
        abstract UpdateRole(
            call: grpc_1.ServerUnaryCall<UpdateRoleRequest, UpdateRoleResponse>,
            callback: grpc_1.sendUnaryData<UpdateRoleResponse>,
        ): void;
        abstract DeleteRole(
            call: grpc_1.ServerUnaryCall<DeleteRoleRequest, DeleteRoleResponse>,
            callback: grpc_1.sendUnaryData<DeleteRoleResponse>,
        ): void;
    }
    export class RoleServiceClient extends grpc_1.makeGenericClientConstructor(UnimplementedRoleServiceService.definition, 'RoleService', {}) {
        ...
        CreateRole: GrpcUnaryServiceInterface<CreateRoleRequest, CreateRoleResponse> = (
            message: CreateRoleRequest,
            metadata: grpc_1.Metadata | grpc_1.CallOptions | grpc_1.requestCallback<CreateRoleResponse>,
            options?: grpc_1.CallOptions | grpc_1.requestCallback<CreateRoleResponse>,
            callback?: grpc_1.requestCallback<CreateRoleResponse>,
        ...
        GetRole: GrpcUnaryServiceInterface<GetRoleRequest, GetRoleResponse> = (
            ...
            metadata: grpc_1.Metadata | grpc_1.CallOptions | grpc_1.requestCallback<GetRoleResponse>,
        ...
        UpdateRole: GrpcUnaryServiceInterface<UpdateRoleRequest, UpdateRoleResponse> = (
            message: UpdateRoleRequest,
            metadata: grpc_1.Metadata | grpc_1.CallOptions | grpc_1.requestCallback<UpdateRoleResponse>,
            options?: grpc_1.CallOptions | grpc_1.requestCallback<UpdateRoleResponse>,
            callback?: grpc_1.requestCallback<UpdateRoleResponse>,
        ): grpc_1.ClientUnaryCall => {
            return super.UpdateRole(message, metadata, options, callback);
        };
        DeleteRole: GrpcUnaryServiceInterface<DeleteRoleRequest, DeleteRoleResponse> = (
            message: DeleteRoleRequest,
            metadata: grpc_1.Metadata | grpc_1.CallOptions | grpc_1.requestCallback<DeleteRoleResponse>,
            options?: grpc_1.CallOptions | grpc_1.requestCallback<DeleteRoleResponse>,
            callback?: grpc_1.requestCallback<DeleteRoleResponse>,
        ): grpc_1.ClientUnaryCall => {
