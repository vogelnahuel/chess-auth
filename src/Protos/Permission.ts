...
export namespace permission {
    export class CreatePermissionRequest extends pb_1.Message {
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): CreatePermissionRequest {
            const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new CreatePermissionRequest();
    ...
    export class CreatePermissionResponse extends pb_1.Message {
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.has_permission)
                writer.writeMessage(2, this.permission, () => this.permission.serialize(writer));
            if (!w)
                return writer.getResultBuffer();
        }
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): CreatePermissionResponse {
            const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new CreatePermissionResponse();
            while (reader.nextField()) {
                if (reader.isEndGroup())
                    break;
                switch (reader.getFieldNumber()) {
    ...
    export class GetPermissionResponse extends pb_1.Message {
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): GetPermissionResponse {
            const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new GetPermissionResponse();
            while (reader.nextField()) {
                if (reader.isEndGroup())
                    break;
                switch (reader.getFieldNumber()) {
    ...
    export class UpdatePermissionRequest extends pb_1.Message {
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): UpdatePermissionRequest {
            const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new UpdatePermissionRequest();
            while (reader.nextField()) {
                if (reader.isEndGroup())
                    break;
                switch (reader.getFieldNumber()) {
    ...
    export class UpdatePermissionResponse extends pb_1.Message {
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): UpdatePermissionResponse {
            const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new UpdatePermissionResponse();
            while (reader.nextField()) {
                if (reader.isEndGroup())
                    break;
                switch (reader.getFieldNumber()) {
    ...
    export class DeletePermissionRequest extends pb_1.Message {
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): DeletePermissionRequest {
            const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new DeletePermissionRequest();
            while (reader.nextField()) {
                if (reader.isEndGroup())
                    break;
                switch (reader.getFieldNumber()) {
    ...
    export class DeletePermissionResponse extends pb_1.Message {
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): DeletePermissionResponse {
            const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new DeletePermissionResponse();
            while (reader.nextField()) {
                if (reader.isEndGroup())
                    break;
                switch (reader.getFieldNumber()) {
    ...
    export abstract class UnimplementedPermissionServiceService {
        ...
        abstract CreatePermission(call: grpc_1.ServerUnaryCall<CreatePermissionRequest, CreatePermissionResponse>, callback: grpc_1.sendUnaryData<CreatePermissionResponse>): void;
        abstract GetPermission(call: grpc_1.ServerUnaryCall<GetPermissionRequest, GetPermissionResponse>, callback: grpc_1.sendUnaryData<GetPermissionResponse>): void;
        abstract UpdatePermission(call: grpc_1.ServerUnaryCall<UpdatePermissionRequest, UpdatePermissionResponse>, callback: grpc_1.sendUnaryData<UpdatePermissionResponse>): void;
        abstract DeletePermission(call: grpc_1.ServerUnaryCall<DeletePermissionRequest, DeletePermissionResponse>, callback: grpc_1.sendUnaryData<DeletePermissionResponse>): void;
    }
    export class PermissionServiceClient extends grpc_1.makeGenericClientConstructor(UnimplementedPermissionServiceService.definition, "PermissionService", {}) {
        constructor(address: string, credentials: grpc_1.ChannelCredentials, options?: Partial<grpc_1.ChannelOptions>) {
            super(address, credentials, options);
        }
        CreatePermission: GrpcUnaryServiceInterface<CreatePermissionRequest, CreatePermissionResponse> = (message: CreatePermissionRequest, metadata: grpc_1.Metadata | grpc_1.CallOptions | grpc_1.requestCallback<CreatePermissionResponse>, options?: grpc_1.CallOptions | grpc_1.requestCallback<CreatePermissionResponse>, callback?: grpc_1.requestCallback<CreatePermissionResponse>): grpc_1.ClientUnaryCall => {
            return super.CreatePermission(message, metadata, options, callback);
        };
        GetPermission: GrpcUnaryServiceInterface<GetPermissionRequest, GetPermissionResponse> = (message: GetPermissionRequest, metadata: grpc_1.Metadata | grpc_1.CallOptions | grpc_1.requestCallback<GetPermissionResponse>, options?: grpc_1.CallOptions | grpc_1.requestCallback<GetPermissionResponse>, callback?: grpc_1.requestCallback<GetPermissionResponse>): grpc_1.ClientUnaryCall => {
            return super.GetPermission(message, metadata, options, callback);
        };
        UpdatePermission: GrpcUnaryServiceInterface<UpdatePermissionRequest, UpdatePermissionResponse> = (message: UpdatePermissionRequest, metadata: grpc_1.Metadata | grpc_1.CallOptions | grpc_1.requestCallback<UpdatePermissionResponse>, options?: grpc_1.CallOptions | grpc_1.requestCallback<UpdatePermissionResponse>, callback?: grpc_1.requestCallback<UpdatePermissionResponse>): grpc_1.ClientUnaryCall => {
            return super.UpdatePermission(message, metadata, options, callback);
        };
        DeletePermission: GrpcUnaryServiceInterface<DeletePermissionRequest, DeletePermissionResponse> = (message: DeletePermissionRequest, metadata: grpc_1.Metadata | grpc_1.CallOptions | grpc_1.requestCallback<DeletePermissionResponse>, options?: grpc_1.CallOptions | grpc_1.requestCallback<DeletePermissionResponse>, callback?: grpc_1.requestCallback<DeletePermissionResponse>): grpc_1.ClientUnaryCall => {
